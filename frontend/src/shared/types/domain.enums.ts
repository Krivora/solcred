...
export type NotificacionTipo = 'ASIGNACION_GESTOR' | 'ASIGNACION_ANALISTA' | 'SOLICITUD_REGRESADA' | 'CAMBIO_ESTATUS' | 'RESPONSABLE_ASIGNADO' | 'DOCUMENTO_RECHAZADO' | 'REASIGNACION_REQUERIDA' | 'SOLICITUD_ESTANCADA'
export const NOTIFICACION_TIPO_VALUES = ['ASIGNACION_GESTOR', 'ASIGNACION_ANALISTA', 'SOLICITUD_REGRESADA', 'CAMBIO_ESTATUS', 'RESPONSABLE_ASIGNADO', 'DOCUMENTO_RECHAZADO', 'REASIGNACION_REQUERIDA', 'SOLICITUD_ESTANCADA'] as const satisfies readonly NotificacionTipo[]

export type NotificacionCanal = 'APP' | 'CORREO'
export const NOTIFICACION_CANAL_VALUES = ['APP', 'CORREO'] as const satisfies readonly NotificacionCanal[]
